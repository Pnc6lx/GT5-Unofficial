        ...
        if (STRUCTURE_DEFINITION == null) {
            STRUCTURE_DEFINITION = StructureDefinition.<MultiBlock_Macerator>builder()
                ...
                .addElement('A', ofChain(
                    addMultiTileCasing(getCasingRegistryID(), getCasingMeta(), ENERGY_IN)
                ))
                .addElement('B', ofChain(
                    addMultiTileCasing(getCasingRegistryID(), getCasingMeta(), FLUID_IN | ITEM_IN | FLUID_OUT | ITEM_OUT)
                ))
